...
The Wedge Project was both challenging and rewarding. It took quite a long time to complete, but I feel that I’ve learned so much throughout the process. Initially, I was not a big fan of Google BigQuery, just as Python was not my favorite tool when I started working with it last spring. However, with practice, these tools have become more familiar, and Python is now one of my favorites to use. Tackling programs outside my comfort zone has been a valuable learning experience.
